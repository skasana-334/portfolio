...
const About = () => {
  return (
   ...
   <div className='shadow-md shadow-sky-400 my-5 '>
    <div className='py-4 max-w-2xl mx-auto text-xl'>I&apos;m a Software Engineer and i have completed my B.Tech in Information Technology from Harcourt Butler Technical University.<br></br>
