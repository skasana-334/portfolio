...
const About = () => {
  return (
   ...
   <div className='shadow-md shadow-sky-400 my-5 '>
    ...
    I am good in problem solving and in DSA(Data Structures & Algorithms).<br></br>
    I am intersested in Front-End Developement also and i have knowledge of Html,Css and Frameworks of Javascript such as React.js and Tailwind css.
